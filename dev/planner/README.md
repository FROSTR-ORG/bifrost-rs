...
9. [09-batch-sign-nonce-model.md](./09-batch-sign-nonce-model.md)
10. [RUNBOOK.md](./RUNBOOK.md)

## Automation

Use `dev/scripts/planner_runbook.sh` for status summaries, next-task selection, status updates, and verification commands.
