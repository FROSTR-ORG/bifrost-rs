...
- Backlog and sequencing: `planner/04-backlog.md`
- Scope and acceptance: `planner/01-scope-and-goals.md`
- Parity tracking: `planner/02-parity-matrix.md`
- Interface decisions: `planner/05-interfaces.md`
- Test gates: `planner/06-test-strategy.md`

## Execution Loop

1. Pick the next task in `planner/04-backlog.md`.
